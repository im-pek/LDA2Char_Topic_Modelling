...
text_file = open('LDA-FastText.txt', 'w')

text_file.write(str(data))

text_file.close()

pyLDAvis.save_html(data,'LDA-FastText Visualisation of LDA.html')
...
model = FastText([overall_list], min_count=1, iter=3, min_n = 1, word_ngrams = 1, sg=1, hs=1, negative=2) #!workers=cores, max_n = 20, size=4, window=3
